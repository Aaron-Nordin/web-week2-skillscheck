...
// Code Here
let myNumbersIndex = []
for(let key in myNumbers){
	myNumbersIndex.push(myNumbers.indexOf(myNumbers[key]))
}
...
// Code Here
let enemies = people.filter(x => x.friend === false)
...
// Code Here
let totallyAwesome = people.reduce((x, y) => x + y.awesomeLevel, 0)
